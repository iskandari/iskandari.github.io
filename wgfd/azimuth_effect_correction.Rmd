...
map(mean_composite_ppi, map=basemap, param='VID', zlim=c(0,100)) + ggtitle("week 18 | hour 3 | composite")
...
map(mean_composite_ppi, map=basemap, param='adjusted_VID', zlim=c(0,100)) + ggtitle("week 18 | hour 3 | composite")
